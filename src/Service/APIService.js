...
class APIService {
  static GEOAPIFY = "74a518e1aa874cbe8ffbcdbad3daf331";
  static MAP_BOX_TOKEN =
    "pk.eyJ1IjoiaXZhbnRvbSIsImEiOiJjbDJmem5nb20wY3VoM2tyenNkZ3FubTZwIn0.Tgnsvhx3FkNoBH1XIBKpxQ";
  static POSITION_STACK = "2b6e5e6ef48e5c6a8ec62a0f8c48e3d3";
  static TOMTOM = "92gCv4E0mDSPc5ZNrNNiejvhkx3x5wo7";
  static PLATFORM =
    "ykt5S9nPF3LgxA7SBr4ot8nTZEICNkbmxq8QeV8Jkp1znFR3goKo1qEPomA8eRHm2bIROgg8Pjx5sigNmRSvsw";
  ...
  static getPlaceLocationFromGeoApify = ({token,place,limit}) =>{
    try{
      let url = `https://api.geoapify.com/v1/geocode/search?text=${place}&apiKey=`+this.GEOAPIFY;
